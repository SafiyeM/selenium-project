...
public class T1_JSExecutor_Scroll {
    ...
    public void scroll_using_js_executor(){
        ...
        // we can manipulate this javascript function by passing many objects like (cydeoLink, homeLink, etc.)
        // and providing the index number where we want to scroll down or up.
        // It finds directly this webElement and go there
